        ...
        {showDemo && (
          <div className="mb-6">
            <button
              ...
              disabled={loading}
              className="w-full py-3 bg-surface border border-gold text-gold font-semibold rounded text-sm tracking-wide hover:bg-gold hover:text-black transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? '...' : 'Continue as Demo'}
            </button>
